      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="relative h-10 w-10 overflow-hidden rounded-full border border-secondary/30 bg-white shadow-sm">
              <Image
                src="/owmotor.jpeg"
                alt="OW Motor Sports"
                fill
            ...
            <h2 className="font-serif text-xl tracking-widest text-primary uppercase">
              OW Motors
            </h2>
          </div>
