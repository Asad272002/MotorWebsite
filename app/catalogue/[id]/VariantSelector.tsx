        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-muted">
              Connect with our team for up-to-date pricing on the <strong className="text-primary">{selectedVariant.cc}cc</strong> model.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href={`https://wa.me/923222033399?text=${encodeURIComponent(
                `Hi, I'm interested in the ${selectedVariant.name} (${selectedVariant.cc}cc ${selectedVariant.brand}). Please share price and availability details.`
              )}`}
              target="_blank"
