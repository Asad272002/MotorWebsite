    ...
    <div className="space-y-8">
                            ...
                            <div className="mt-2 w-72 rounded-md border border-[#E5E7EB] bg-[#F7F7F8] p-3 shadow-lg">
                              <AdminForm action={updateStaffUser} submitLabel="Update user" className="space-y-3 text-xs" showStatus={false}>
                                ...
                                <div>
                                  ...
                                  <input name="newPassword" type="password" autoComplete="new-password" placeholder="New password 8+ chars" className={`${adminInputClass} min-h-9`} />
                                </div>
                              </AdminForm>
      ...
      <section id="new-user">
        <AdminPanel
          ...
          description="Enter the details below. The password is shown once after account creation and is never stored in the staff profile. Share it securely."
        >
          <AdminForm
          ...
          >
            ...
            <div>
              ...
              <input name="password" type="password" autoComplete="new-password" minLength={8} required className={adminInputClass} placeholder="8+ characters — share with user" />
            </div>
          </AdminForm>
        </AdminPanel>
      </section>
