              ...
              <div key={s.id} className="rounded-lg border border-[#E5E7EB] bg-white shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 p-5 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <dl className="mt-3 space-y-2 text-sm">
                      <div className="flex justify-between border-b border-[#F3F4F6] pb-2"><dt className="text-[#6B7280]">Original price</dt><dd className="font-semibold">{pkr(s.original_amount)}</dd></div>
                      {s.discount_amount > 0 ? <div className="flex justify-between border-b border-[#F3F4F6] pb-2"><dt className="text-[#6B7280]">Discount</dt><dd className="font-semibold text-[#15803D]">- {pkr(s.discount_amount)}</dd></div> : null}
